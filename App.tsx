...
export default function App() {
  ...
  if (screen === 'summary') return <SessionSummaryScreen activityTimeline={activityTimeline} lobbyName={gameLobbyName} onBack={goBack} onHome={returnHome} paymentUserId={playerId} players={finalPlayers} roomCode={gameRoomCode} timelineLabels={timelineLabels ?? undefined} />;
