...
export function StackDetectorScreen({ onOpenHistory }: { onOpenHistory?: () => void }) {
  ...
  return <SafeAreaView style={[styles.safeArea, isBrowserSimulator && styles.webCanvas]}><StatusBar barStyle="light-content" /><View style={[styles.container, isBrowserSimulator && styles.phoneFrame]}>
    <View style={styles.titleRow}><View><Text style={styles.eyebrow}>STACK LOBBY</Text><Text style={styles.title}>Phones, ready together.</Text></View>{onOpenHistory && <Pressable onPress={onOpenHistory} style={styles.historyButton}><Text style={styles.historyButtonText}>History</Text></Pressable>}</View>
...
const styles = StyleSheet.create({
  titleRow: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }, historyButton: { backgroundColor: '#26324A', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9 }, historyButtonText: { color: '#AFC2FF', fontSize: 13, fontWeight: '800' },
